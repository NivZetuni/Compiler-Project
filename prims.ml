...
module Prims : PRIMS = struct
  ...
  let apply = 
    let label = "apply" in
    let body =
      "mov r8, qword[rbp + 3*8] ;insert n to r8\n"^
      "add r8, 3 \n"^
      "lea r8, [rbp + 8*r8] ;r8 have the address to the list\n"^
      "mov r9, qword[r8] ;r9 have the list\n"^
      "mov r10, 0 ; r10 will have the new number of arguments\n"^
      (* this is the part of inserting the list args *)
      ".addListArgs:\n"^
      "cmp byte[r9],T_NIL ;check if list is empty\n"^
      "je .doneWithList \n"^
      "CAR r11, r9 ;putting the first arg in r11\n"^
      "push r11 ;put it in the stuck\n"^
      "inc r10 \n"^
      "CDR r9,r9 ; r9 have the rest of the list \n"^
      "jmp .addListArgs \n"^
      (* after finishing to push the list args *)
      ".doneWithList:\n"^
      "mov r9,rsp ;r9 now have the address of the lower arg (if exist) \n"^
      "lea r12, [rbp - 8] ;r12 have the address of the higher arg(if exist) \n"^
      (* after having the the args, we reverse them *)
      ".reverseListArgs:\n"^
      "cmp r9, r12 \n"^
      "jnl .restArgs ;if r9 > or = to r12, we done\n"^
      "mov r13, qword[r12] ;r13 have the element on the address of r12\n"^
      "mov r14, qword[r9] ;r14 have the element on the address of r9\n"^
      "mov qword[r12], r14\n"^
      "mov qword[r9], r13\n"^
      "add r9, 8\n"^
      "sub r12, 8\n"^
      "jmp .reverseListArgs\n"^
      (* adding the rest of the args (if existing) *)
      ".restArgs:\n"^
      "lea r9, [rbp + 5*8] ;r9 now have the address of the first arg\n"^
      ".restArgsLoop:\n"^
      "cmp r9,r8 ;check if r9 have the same address of the list arg\n"^
      "je .setProc\n"^
      "sub r8, 8\n"^
      "push qword[r8]\n"^
      "inc r10 \n"^
      ...
      ".setProc: \n"^
      "push r10 ;put the number of elements in the stuck\n"^
      "mov r8, qword[rbp + 4*8] ;r8 hold the proc\n"^
      "mov r14, qword[rbp + 4*8] ;r8 hold the proc\n"^
      "CLOSURE_ENV r9, r8 ;r9 hold the env of the proc\n"^
      "push r9 \n"^
      "push qword[rbp +8*1] ;push the old ret address\n"^

      "mov r8, [rbp] ;r8 holds the old value of rbp \n"^
      "mov r10, qword[rbp+ 3*8] ;r10 holds old n value \n"^
      "add r10, 3 \n"^
      "lea r10, [rbp + 8*r10] \n"^
      ...
      "CLOSURE_CODE r9, r14 ;r9 hold the code of the proc\n"^
      "jmp r9 \n" in
  ...
  let procs = String.concat "\n\n" [type_queries ; numeric_ops; misc_ops; set_cdr; set_car; cons; car ; cdr; apply;];;
end;;
